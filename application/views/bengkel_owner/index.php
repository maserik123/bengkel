...
<head>
    ...
    <link href="<?php echo base_url('components_owner/') ?>vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body id="page-top">
    <script type="text/javascript">
        function logout() {
            swal({
                ...
                function() {
                    $.ajax({
                        url: "<?php echo site_url('AuthOwner/logout'); ?>",
                        type: "POST",
                        dataType: "JSON",
                        data: {
                        ...
                        success: function(data) {
                            $url = '<?php echo base_url('/AuthOwner/') ?>';
                            setTimeout(() => {
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('owner') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url('owner/dataBengkel') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url('owner/dataOwner') ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $this->session->userdata('first_name') . ' ' . $this->session->userdata('last_name'); ?> <i class="fa fa-chevron-down"></i> </span>
                            </a>
    ...
    <!-- Page level plugins -->
    <script src="<?php echo base_url('components_owner/') ?>vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="<?php echo base_url('components_owner/') ?>vendor/datatables/dataTables.bootstrap4.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?php echo base_url('components_owner/') ?>js/demo/datatables-demo.js"></script>
