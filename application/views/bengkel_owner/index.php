...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="<?php echo base_url('components_owner/') ?>vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?php echo base_url('components_owner/') ?>js/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url('components_owner/') ?>js/demo/chart-pie-demo.js"></script>
