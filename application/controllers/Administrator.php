...
class administrator extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(['Bengkel_model', 'JenisBengkel_model', 'PemilikBengkel_model']);
    }
    ...
    function bengkelTerdaftar($param = '', $id = '')
    {
        ...
        if ($param == 'getAllData') {
            ...
            foreach ($dt['data'] as $row) {
                ...
                $th8  = '<div style="font-size:12px;">' . $row->jadwal_bengkel . '</div>';
                $th9  = '<div style="font-size:12px;">' . $row->latitude . '</div>';
                $th10 = '<div style="font-size:12px;">' . $row->longitude . '</div>';
